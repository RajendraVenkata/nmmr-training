...
// ── Course definitions ─────────────────────────────────────────────
const COURSES = [
  { id: "b1", file: "beginner/B1-foundations-of-ai-and-llms.md", cat: "AI Foundations", diff: "beginner", price: 2999, order: 1, courseNumber: "B1" },
  { id: "b2", file: "beginner/B2-python-for-ai.md", cat: "AI Foundations", diff: "beginner", price: 2999, order: 2, courseNumber: "B2" },
  { id: "b3", file: "beginner/B3-llm-api-keys-and-interaction-reference.md", cat: "LLM Providers", diff: "beginner", price: 2999, order: 3, courseNumber: "B3" },
  { id: "b4", file: "beginner/B4-prompt-engineering-fundamentals.md", cat: "Prompt Engineering", diff: "beginner", price: 2999, order: 4, courseNumber: "B4" },
  { id: "b5", file: "beginner/B5-introduction-to-ai-agents.md", cat: "Agentic AI", diff: "beginner", price: 2999, order: 5, courseNumber: "B5" },
  { id: "b6", file: "beginner/B6-tool-calling.md", cat: "Agentic AI", diff: "beginner", price: 2999, order: 6, courseNumber: "B6" },
  { id: "b7", file: "beginner/B7-building-your-first-agent-with-langchain.md", cat: "Agentic AI", diff: "beginner", price: 2999, order: 7, courseNumber: "B7" },
  { id: "b8", file: "beginner/B8-introduction-to-rag.md", cat: "RAG & Retrieval", diff: "beginner", price: 2999, order: 8, courseNumber: "B8" },
  { id: "b9", file: "beginner/B9-provider-abstraction.md", cat: "Agentic AI", diff: "beginner", price: 2999, order: 9, courseNumber: "B9" },
  { id: "b10", file: "beginner/B10-beginner-capstone-project.md", cat: "Agentic AI", diff: "beginner", price: 2999, order: 10, courseNumber: "B10" },
